...
namespace Wini.SaleMultipleChannel.Lazop
{
    ...
    public class LazopClient : ILazopClient
    {
        ...
        public LazopClient(string serverUrl, string appKey, string appSecret)
        {
            ...
            topLogger = LazopLogger.Instance;
        }
        ...
        {
            webUtils.ReadWriteTimeout = readWriteTimeout;
        }
        ...
        {
            webUtils.IgnoreSSLCheck = ignore;
        }
        ...
        {
            webUtils.DisableWebProxy = disable;
        }
        ...
        {
            customrParameters = customParameters;
        }
        ...
        private LazopResponse DoExecute(LazopRequest request, string accessToken, DateTime timestamp)
        {
            ...
            txtParams.AddAll(customrParameters);
            ...
            txtParams.Add(Constants.SIGN, LazopUtils.SignRequest(request.GetApiName(), txtParams, appSecret, signMethod));
